...
class Settings(BaseSettings):
    ...
    retention_initial_delay_seconds: int = 15
    retention_interval_seconds: int = 300
    persist_raw_trades: bool = False
    persist_order_book_top: bool = True
    max_database_bytes: int = 4500000000
    database_guard_check_interval_seconds: int = 60
